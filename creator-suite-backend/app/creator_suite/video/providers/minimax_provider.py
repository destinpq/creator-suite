...
from app.creator_suite.video.schemas.minimax_schemas import MinimaxVideoInput, MinimaxVideoOutput
...
class MinimaxVideoProvider(BaseProvider):
    ...
    def validate_input(self, input_data: Dict[str, Any]) -> MinimaxVideoInput:
        """Validate and transform input data"""
        return MinimaxVideoInput(**input_data)
    
    def get_input_schema(self) -> Dict[str, Any]:
        """Get the JSON schema for input validation"""
        return {
            "type": "object",
            "title": "MinimaxVideoInput",
            "required": ["prompt"],
            "properties": {
                "prompt": {
                    "type": "string",
