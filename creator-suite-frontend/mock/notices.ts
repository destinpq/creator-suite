  ...
  res.json({
    data: [
      ...
      },
      {
        ...
        title: 'Qu Nini, whom you recommended, passed the third round of interviews',
        datetime: '2017-08-08',
        type: 'notification',
      },
      {
      ...
      },
      {
        ...
        title: 'Content should not exceed two lines, automatically truncated when exceeded',
        datetime: '2017-08-07',
        type: 'notification',
      },
      {
      ...
      },
      {
        ...
        description: 'This template is used to remind who interacted with you, place the avatar of "who" on the left side',
        datetime: '2017-08-07',
        type: 'message',
        clickClose: true,
      },
      ...
      },
      {
        id: '000000009',
        title: 'Task Name',
        description: 'Task needs to be started before 2017-01-12 20:00',
        extra: 'Not Started',
        status: 'todo',
        type: 'event',
      },
      {
        ...
        description:
          'Submitted by Guanlin on 2017-01-06, code change task needs to be completed before 2017-01-07',
        extra: 'Due Soon',
        status: 'urgent',
        type: 'event',
      },
