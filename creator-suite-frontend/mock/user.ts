...
/**
 * Current user permissions, empty means not logged in
 * current user access， if is '', user need login
 * If it is a pro preview, it has permissions by default
 */
let access =
...
// The code will be compatible with local service mock and static data of deployment sites
export default {
  // Supports values as Object and Array
  'GET /api/currentUser': (_req: Request, res: Response) => {
    ...
    res.send({
      ...
      data: {
        ...
        signature: 'Embrace all rivers, tolerance is great',
